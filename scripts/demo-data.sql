...
VALUES (
  ...
  'B2B SaaS companies with 10-200 person sales teams, primarily in UK and Europe. Sweet spot: Series A to Series C companies with complex sales cycles (30-90 days) selling GBP20k-GBP200k ACV deals.',
...
-- Deal 1: TechFlow Solutions -- GBP48k -- Closed Won
...
-- Deal 2: Meridian Capital -- GBP72k -- Closed Won
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, outcome, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
  ...
  'Meridian Capital is a financial services firm (private equity advisory) with a 40-person business development team. James Porter (CRO) was referred by an investor who had seen Halvex in action. Their primary pain was deals falling through cracks in a fast-moving pipeline -- they were losing ~GBP2M/quarter in preventable deal slippage.',
  72000,
  'closed_won',
  'won',
  'recurring',
...
-- Deal 3: NovaBridge Labs -- GBP36k -- Closed Won
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, outcome, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 4: Apex Dynamics -- GBP96k -- Closed Won
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, outcome, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
  ...
  'Apex Dynamics is a UK industrial automation company (GBP50M revenue, 200 employees) with a 60-person commercial team. Michael Ross needed board-ready pipeline reports that didn''t require a week of manual preparation. Complex enterprise deal with 4 stakeholders and full procurement process.',
  96000,
  'closed_won',
  'won',
  'recurring',
...
-- Deal 6: Ironforge Industries -- GBP120k -- Closed Lost
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, outcome, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 7: BlueHorizon Media -- GBP24k -- Closed Lost
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, outcome, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 8: Quantum Retail -- GBP60k -- Closed Lost
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, outcome, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 9: Sentinel Security -- Discovery -- GBP84k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
...
-- Deal 10: Pinnacle Health -- Discovery -- GBP42k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 11: Atlas Shipping -- Discovery -- GBP66k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 12: Vanguard Finance -- Proposal -- GBP108k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 13: Sterling Consulting -- Proposal -- GBP78k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 14: Nexus Telecom -- Proposal -- GBP132k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 15: Oakwood Properties -- Proposal -- GBP48k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
  ...
  'annual',
  '["HubSpot native reporting"]'::jsonb,
  E'## Discovery Call -- 11 Mar 2026\nAttendees: Hannah Baker (Sales Manager), Rees (Halvex)\n\nHannah runs a 10-person team selling commercial properties (offices, warehouses, retail spaces). Average deal is GBP1-5M with 3-6 month cycles. She currently tracks everything in spreadsheets + HubSpot.\n\nHer pain: "I spend every Friday afternoon pulling together a pipeline report for James (MD). I know there must be a better way." She saw our LinkedIn ad and was curious.\n\nConcern: "We''re a small company. I need to make sure the cost is justified for a 10-person team." Very price conscious.\n\nBudget: Hannah said she needs James to approve anything over GBP20k. She thinks GBP40-50k is "a stretch but possible if the ROI is clear."\n\n---\n\n## Demo -- 18 Mar 2026\nAttendees: Hannah Baker, James Oakley (MD)\n\nJames was initially sceptical about the price but became interested when he saw the auto-generated pipeline summary. "If this means Hannah doesn''t spend every Friday on reports, and I get better information, it could work."\n\nHannah asked about a smaller package or month-to-month option. We discussed our Growth Plan at GBP48k/yr but noted we don''t currently offer monthly billing for that tier.\n\nJames said: "Send us the proposal. I want to see the numbers and think about it over the weekend."',
  'Small opportunity with Oakwood Properties (GBP48k). Sales Manager Hannah Baker is the champion, MD James Oakley is the decision maker. Price sensitive -- small team, limited tech budget. Demo went well but pricing is a stretch. Proposal sent, waiting on MD decision.',
  42,
  '{"champion":"Hannah Baker (Sales Manager)","championConfirmed":true,"budgetStatus":"stretch","budgetAmount":"GBP40-50k stretch budget","timeline":"Thinking it over -- no firm timeline","decisionMaker":"James Oakley (MD)","nextMeeting":"2026-03-28","buyingSignals":["Proposal requested by MD","Pipeline reporting pain is real","Demo resonated with decision maker"]}'::jsonb,
...
-- Deal 16: Zenith Aerospace -- Trial -- GBP144k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 17: Harbour Logistics -- Trial -- GBP72k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
  ...
  'Pilot with Harbour Logistics (GBP72k) going well. 3 reps in 2-week trial, all actively engaged. Team Lead Liam O''Brien is already an advocate -- signal extraction caught a budget concern he would have missed. Sophie Bennett extending trial by one week while sorting budget for full rollout. Strong buying signal.',
  65,
...
-- Deal 18: Crestline Partners -- Trial -- GBP96k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 19: Evergreen Energy -- Trial -- GBP60k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 20: Monarch Insurance -- Verbal Commit -- GBP156k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 21: Brightwave Digital -- Verbal Commit -- GBP84k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 22: Ironclad Cyber -- Verbal Commit -- GBP108k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 23: Paramount Media Group -- Negotiation -- GBP180k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
  ...
  'Paramount Media Group is a large media conglomerate (GBP200M revenue, 500 employees) with a 90-person sales operation across 3 divisions. Victoria Lane is negotiating a multi-year deal with significant pricing pressure. Our largest potential deal at GBP180k/yr.',
  180000,
  'negotiation',
  'recurring',
  'annual',
  '["Gong", "Clari"]'::jsonb,
  E'## Executive Presentation -- 14 Feb 2026\nAttendees: Victoria Lane (CMO/CRO), Natasha Price (Head of Sales), Rees (Halvex)\n\nParamount Media Group has 90 sales reps across 3 divisions (advertising sales, content licensing, events). Victoria oversees all commercial operations. She''s looking for a unified deal intelligence platform across all divisions.\n\nNatasha said: "Each division uses different tools -- one has Gong, one has Clari, one has nothing. We need one platform that works for all three." This is a consolidation play.\n\nBudget: Victoria mentioned "significant investment" but asked for multi-year pricing before committing to a number. "If we''re doing this, we''re doing it properly -- 3-year deal minimum."\n\n---\n\n## Multi-Division Demo -- 28 Feb 2026\nAttendees: Victoria Lane, Natasha Price, + division leads (3 people), Rees (Halvex)\n\nDemoed the platform with use cases from each division. Advertising sales loved the email signal extraction. Content licensing liked the conversion scoring. Events team was interested in the pipeline summaries.\n\nAll three division leads were positive. Victoria said: "This is the first tool all three of my teams have agreed on. Let''s talk numbers."\n\n---\n\n## Pricing Negotiation -- 14 Mar 2026\nAttendees: Victoria Lane, James Whitfield (CFO), Edward Kim (Procurement Director), Rees (Halvex)\n\nOur proposal: GBP180k/yr for 90 seats. Victoria asked for multi-year pricing: "I want a 3-year deal at a meaningful discount. We''re giving you stability and scale -- that should be worth something."\n\nJames Whitfield (CFO) pushed harder: "I need to see this under GBP150k/yr for a 3-year commitment." That''s a 17% discount -- aggressive but not unreasonable for a 3-year deal.\n\nWe countered: GBP165k/yr on a 3-year term (8% discount). Victoria said: "We''re close. Let me discuss with James and come back. Can you also include premium support at that rate?"\n\nNegotiation ongoing. Still GBP15k/yr apart.\n\n---\n\n## Latest Update -- 21 Mar 2026\nVictoria emailed: "James will accept GBP170k/yr if you include premium support and quarterly executive reviews. That''s my final number." This is a good outcome -- GBP170k x 3 years = GBP510k TCV.\n\nI''m reviewing internally whether we can include premium support at that rate. Need to decide by March 28.',
  'Advanced negotiation with Paramount Media Group (GBP180k target, likely GBP170k). Consolidating 3 divisions (Gong, Clari, nothing) onto one platform. Victoria Lane negotiating multi-year deal -- CFO James Whitfield proposed GBP170k/yr with premium support on a 3-year term (GBP510k TCV). Decision on premium support inclusion by March 28.',
  78,
  '{"champion":"Victoria Lane (CMO/CRO)","championConfirmed":true,"budgetStatus":"negotiating","budgetAmount":"GBP170k/yr proposed (3-year = GBP510k TCV)","timeline":"Decision by end of March","decisionMaker":"James Whitfield (CFO) -- final commercial authority","nextMeeting":"2026-03-28","buyingSignals":["All 3 divisions aligned","Multi-year commitment offered","CFO engaged on final terms","Consolidation play from competitors","GBP510k TCV potential"]}'::jsonb,
  '[{"text":"Review internally if premium support can be included at GBP170k/yr","completed":false,"createdAt":"2026-03-21T00:00:00Z"},{"text":"Model 3-year deal economics at GBP170k/yr + premium support","completed":false,"createdAt":"2026-03-21T00:00:00Z"},{"text":"Prepare counter-proposal or acceptance by March 28","completed":false,"createdAt":"2026-03-21T00:00:00Z"}]'::jsonb,
  '[{"title":"Final Terms Discussion","date":"2026-03-28T14:00:00Z","type":"meeting","attendees":["Victoria Lane","James Whitfield","Rees"],"notes":"Present decision on GBP170k/yr + premium support. Target: handshake agreement."}]'::jsonb,
  '2026-04-15T00:00:00Z',
  1,
  '2026-02-14T00:00:00Z',
  '2026-03-23T00:00:00Z'
...
-- Deal 24: Summit Financial -- Negotiation -- GBP120k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
...
-- Deal 25: Redwood Analytics -- Negotiation -- GBP72k
INSERT INTO deal_logs (
  workspace_id, user_id, deal_name, prospect_company, prospect_name, prospect_title,
  contacts, description, deal_value, stage, deal_type, recurring_interval,
  competitors, meeting_notes, ai_summary, conversion_score, intent_signals,
