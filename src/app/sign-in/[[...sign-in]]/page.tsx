    ...
    <main style={{ minHeight: '100dvh', backgroundColor: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ width: '100%', maxWidth: '400px', padding: '24px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', marginBottom: '32px' }}>
          ...
          <span style={{ fontWeight: '700', fontSize: '17px', letterSpacing: 0, color: 'var(--text-primary)' }}>Halvex CRM</span>
        </div>

        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          <h1 style={{ fontSize: '20px', fontWeight: '700', letterSpacing: 0, color: 'var(--text-primary)', marginBottom: '6px' }}>Welcome back</h1>
          <p style={{ fontSize: '13px', color: 'var(--text-tertiary)' }}>Sign in to your sales workspace</p>
        </div>
