  ...
  },
  {
    ...
    preview: {
      ...
      items: [
        ...
        { label: 'Key differentiator', value: 'DealKit costs 4x less for sales-only teams', color: '#22C55E' },
      ],
    },
  },
  {
    ...
    <section id="features" style={{ position: 'relative', zIndex: 1, maxWidth: '960px', margin: '0 auto', padding: '0 32px 100px' }}>
      <div style={{ textAlign: 'center', marginBottom: '48px' }}>
        ...
        <p style={{ color: '#7E7A9A', fontSize: '15px' }}>
          From first call to closed deal — DealKit has the context you need at every stage.
        </p>
      </div>
