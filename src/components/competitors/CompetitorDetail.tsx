...
export function CompetitorDetail({ competitor, collateral, linkedDeals, onSave, onGenerateBattlecard }: CompetitorDetailProps) {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: '24px', alignItems: 'start' }}>
      {/* Left: form */}
      <div>
        <div style={{ backgroundColor: '#141414', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '8px', padding: '20px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        {/* Battlecard card */}
        <div style={{ backgroundColor: '#141414', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '8px', padding: '16px' }}>
          ...
          {linkedDeals.length === 0 ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              {linkedDeals.slice(0, 5).map((deal) => (
                <div key={deal.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 10px', borderRadius: '6px', backgroundColor: '#0A0A0A', border: '1px solid rgba(255,255,255,0.06)' }}>
                  <div>
